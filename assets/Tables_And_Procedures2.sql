...
--
-- Temporary view structure for view `location_rankings`
--
...
--
-- Temporary view structure for view `users_passless`
--

DROP TABLE IF EXISTS `users_passless`;
...
--
-- Final view structure for view `location_rankings`
--
...
/*!50001 VIEW `location_rankings` AS select `r`.`location_id` AS `location_id`,sum(`r`.`ranking`) AS `ranking` from `rankings` `r` group by `r`.`location_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `users_passless`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `users_passless` AS select `U`.`id` AS `id`,`U`.`name` AS `name`,`U`.`email` AS `email`,`U`.`role_id` AS `role_id` from `users` `U` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-04-20  9:24:36
